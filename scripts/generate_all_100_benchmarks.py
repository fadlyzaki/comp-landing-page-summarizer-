#!/usr/bin/env python3
"""
Full Generator for 100 Curated Benchmarks across 5 balanced categories (20 each).
Output: frontend/src/lib/liveDemos.ts
"""
...
def generate_ts():
    ...
    print(f"DevTools count: {len(dev_tools)}")
    return dev_tools
