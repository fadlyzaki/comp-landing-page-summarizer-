/**
 * Full 100 Curated Benchmarks Builder (TypeScript output)
 * 5 Categories x 20 Products = 100 Total Benchmarks
 */

const fs = require('fs');
const path = require('path');

// We will construct the 5 categories
const data = [];
...
console.log("DevTools count:", data.length);
